...
const services = [
  {
    ...
    desc: 'Защита наиболее уязвимых мест кузова — пороги, бамперы, арки, зеркала.',
    price: 'от 2 000 ₽',
    badge: 'Популярное',
    highlight: false,
  },
  {
    ...
    desc: 'Восстановление прозрачности и оклейка фар защитной плёнкой — долговечный результат.',
    price: 'от 5 000 ₽',
    badge: null,
    highlight: false,
  },
  {
    ...
    desc: 'Оклейка кузова матовой PPF-плёнкой — эффектно и надёжно.',
    price: 'от 20 000 ₽',
    badge: 'Топ',
    highlight: true,
  },
  {
    ...
    desc: 'Качественные тонировочные плёнки разного светопропускания. ГОСТ-тонировка.',
    price: 'от 5 000 ₽',
    badge: null,
    highlight: false,
  },
  {
    ...
    desc: 'Надёжная защита оптики от сколов, царапин и ультрафиолета.',
    price: 'По запросу',
    badge: null,
    highlight: false,
  },
  {
    ...
    desc: 'Защита кузова от ударов гравия, песка и мелких камней на дороге.',
    price: 'По запросу',
    badge: null,
    highlight: false,
  },
  {
    ...
    desc: 'Изменение цвета и стиля автомобиля с помощью качественного винила.',
    price: 'По запросу',
    badge: null,
    highlight: false,
  },
  {
    ...
    desc: 'Комплексная подготовка авто перед продажей — первое впечатление решает.',
    price: 'По запросу',
    badge: null,
    highlight: false,
  },
  {
    ...
    desc: 'Профессиональная чистка сидений, потолка, торпеды и ковриков.',
    price: 'По запросу',
    badge: null,
    highlight: false,
  },
...
export default function Services() {
  ...
  return (
    <section id="services" ref={sectionRef} className="py-20 md:py-28" style={{ background: '#0a0a0a' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14 reveal">
          ...
          <p className="text-white/50 max-w-xl mx-auto">
            Работаем только с проверенными материалами. Каждая работа выполняется аккуратно и с гарантией качества.
          </p>
        </div>
        ...
        <div className="text-center mt-12 reveal">
          <p className="text-white/40 mb-4 text-sm">Не нашли нужную услугу? Свяжитесь с нами — обсудим детали</p>
          <a
