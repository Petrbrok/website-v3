    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-24">
        <div className="max-w-2xl">
          ...
          >
            Тонировка и бронирование<br />
            <span className="gradient-text">вашего авто</span>
          </h1>
          ...
          >
            Профессиональная защита кузова и тонирование. Работаем аккуратно, даём гарантию.
          </p>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 mb-10">
            ...
            <a
              ...
              className="btn-secondary justify-center sm:justify-start md:hidden"
            >
